...
async function groupTriggerSEEUpdate(req, res) {
...
export default function groupTriggerSEEUpdateRoute(app) {
    return app.post('/grouptriggerseeupdate', groupTriggerSEEUpdate);
}
