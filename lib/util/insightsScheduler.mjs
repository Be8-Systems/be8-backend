...
async function fetchAndStoreInsights(key) {
    ...
    const insightObject = {
        ...
        images: fixedInsights[4],
        sentInviteLinks: fixedInsights[5],
        usedInviteLinks: fixedInsights[6],
        sentGrouInviteLinks: fixedInsights[7],
        usedGroupInviteLinks: fixedInsights[8],
    };
